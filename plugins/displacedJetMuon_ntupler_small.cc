// -*- C++ -*-
// Class:      displacedJetMuon_ntupler_small
/*
...
#include "displacedJetMuon_ntupler_small.h"
...
} my_largest_muonCscLayers_small;

//------ Constructors and destructor ------//
displacedJetMuon_ntupler_small::displacedJetMuon_ntupler_small(const edm::ParameterSet& iConfig):
...
displacedJetMuon_ntupler_small::~displacedJetMuon_ntupler_small()
{
};
...
void displacedJetMuon_ntupler_small::setBranches()
{
...
void displacedJetMuon_ntupler_small::enableEventInfoBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("fixedGridRhoAll", &fixedGridRhoAll, "fixedGridRhoAll/F");
...
void displacedJetMuon_ntupler_small::enablePVAllBranches()
{
...
void displacedJetMuon_ntupler_small::enablePileUpBranches()
{
...
void displacedJetMuon_ntupler_small::enableMuonBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("muon_d0", muon_d0, "muon_d0[nMuons]/F");
	...
	/* GK  displacedJetMuonTree->Branch("muon_ptrel", muon_ptrel, "muon_ptrel[nMuons]/F");
...
void displacedJetMuon_ntupler_small::enableElectronBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("EleE_SC", eleE_SC,"eleE_SC[nElectrons]/F");
	...
	/* GK  displacedJetMuonTree->Branch("ele_d0", ele_d0, "ele_d0[nElectrons]/F");
	...
	/* GK  displacedJetMuonTree->Branch("ele_MissHits", ele_MissHits, "ele_MissHits[nElectrons]/I");
...
void displacedJetMuon_ntupler_small::enableTauBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("tau_passEleVetoLoose", tau_passEleVetoLoose, "tau_passEleVetoLoose[nTaus]/O");
...
void displacedJetMuon_ntupler_small::enablePhotonBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("phoSigmaIetaIeta", phoSigmaIetaIeta, "phoSigmaIetaIeta[nPhotons]/F");
	...
	/* GK  displacedJetMuonTree->Branch("pho_trkSumPtHollowConeDR03", pho_trkSumPtHollowConeDR03, "pho_trkSumPtHollowConeDR03[nPhotons]/F");
...
void displacedJetMuon_ntupler_small::enablePFCandidateBranches()
{
...
void displacedJetMuon_ntupler_small::enableMuonSystemBranches()
{
		...
		/* GK    displacedJetMuonTree->Branch("cscSegChi2",cscSegChi2,"cscSegChi2[nCscSeg]/F");
		...
		/* GK   displacedJetMuonTree->Branch("cscRechitsTpeak",cscRechitsTpeak,"cscRechitsTpeak[ncscRechits]/F");
		...
		/* GK displacedJetMuonTree->Branch("nMatchedSimHits",nMatchedSimHits,"nMatchedSimHits[nCscRecHits]/I");
		...
		*/ 
		...
		/* GK   displacedJetMuonTree->Branch("cscSegClusterTime",             cscSegClusterTime,             "cscSegClusterTime[nCscSegClusters]/F");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtRechitTime",             dtRechitTime,             "dtRechitTime[nDtRechits]/F");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtRechitClusterTime",             dtRechitClusterTime,             "dtRechitClusterTime[nDtRechitClusters]/F");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtRechitClusterJetVetoPt",       dtRechitClusterJetVetoPt,       "dtRechitClusterJetVetoPt[nDtRechitClusters]/F");
		...
		*/
		...
		/* GK    displacedJetMuonTree->Branch("rpcT",rpcT,"rpcT[nRpc]/F");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtSegStation",dtSegStation,"dtSegStation[nDtSeg]/I");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtSegClusterTime",             dtSegClusterTime,             "dtSegClusterTime[nDtSegClusters]/F");
		...
		*/
		...
		/* GK   displacedJetMuonTree->Branch("dtSegClusterJetVetoPt",       dtSegClusterJetVetoPt,       "dtSegClusterJetVetoPt[nDtSegClusters]/F");
...
void displacedJetMuon_ntupler_small::enableHORechitBranches()
{
	/* GK  displacedJetMuonTree->Branch("nHORechits", &nHORechits,"nHORechits/I");
...
void displacedJetMuon_ntupler_small::enableEcalRechitBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("ecalRechit_E_Error", ecalRechit_E_Error, "ecalRechit_E_Error[nRechits]/F");
...
void displacedJetMuon_ntupler_small::enableHBHERechitBranches()
{
	...
	// GK  displacedJetMuonTree->Branch("hbheRechit_cctime", hbheRechit_cctime, "hbheRechit_cctime[nHBHERechits]/F");
...
void displacedJetMuon_ntupler_small::enableTrackBranches()
{
...
void displacedJetMuon_ntupler_small::enableSecondaryVerticesBranches()
{
...
void displacedJetMuon_ntupler_small::enableJetBranches()
{
	...
	/* GK  displacedJetMuonTree->Branch("jetCSV", jetCSV,"jetCSV[nJets]/F");
	...
	// GK  displacedJetMuonTree->Branch("jetPassMuFrac", jetPassMuFrac, "jetPassMuFrac[nJets]/O");
	// GK  displacedJetMuonTree->Branch("jetPassEleFrac", jetPassEleFrac, "jetPassEleFrac[nJets]/O");
	...
	// GK  displacedJetMuonTree->Branch("jetHOEnergyFraction", jetHOEnergyFraction, "jetHOEnergyFraction[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetHFHadronEnergyFraction", jetHFHadronEnergyFraction, "jetHFHadronEnergyFraction[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetHFEMEnergyFraction",jetHFEMEnergyFraction, "jetHFEMEnergyFraction[nJets]/F");
	...
	// GK  displacedJetMuonTree->Branch("jetAllMuonPt", jetAllMuonPt,"jetAllMuonPt[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetAllMuonEta", jetAllMuonEta,"jetAllMuonEta[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetAllMuonPhi", jetAllMuonPhi,"jetAllMuonPhi[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetAllMuonM", jetAllMuonM,"jetAllMuonM[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetPtWeightedDZ", jetPtWeightedDZ,"jetPtWeightedDZ[nJets]/F");
	...
	/* GK displacedJetMuonTree->Branch("jetAlphaMax",jetAlphaMax,"jetAlphaMax[nJets]/F");
	...
	// GK  displacedJetMuonTree->Branch("jetMedianTheta2D",jetMedianTheta2D,"jetMedianTheta2D[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetMedianIP",jetMedianIP,"jetMedianIP[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetMinDeltaRAllTracks",jetMinDeltaRAllTracks,"jetMinDeltaRAllTracks[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jetMinDeltaRPVTracks",jetMinDeltaRPVTracks,"jetMinDeltaRPVTracks[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jet_sig_et1",jet_sig_et1,"jet_sig_et1[nJets]/F");
	// GK  displacedJetMuonTree->Branch("jet_sig_et2",jet_sig_et2,"jet_sig_et2[nJets]/F");
	displacedJetMuonTree->Branch("jet_energy_frac",jet_energy_frac,"jet_energy_frac[nJets]/F");

	/* GK  displacedJetMuonTree->Branch("jetAlphaMax_wp",jetAlphaMax_wp,"jetAlphaMax_wp[nJets]/F");
...
void displacedJetMuon_ntupler_small::enableJetAK8Branches()
{
	...
	// GK  displacedJetMuonTree->Branch("fatJetCorrectedPt", fatJetCorrectedPt,"fatJetCorrectedPt[nFatJets]/F");
	...
	/* GK  displacedJetMuonTree->Branch("fatJetPrunedM", fatJetPrunedM,"fatJetPrunedM[nFatJets]/F");
	...
	// GK  displacedJetMuonTree->Branch("fatJetHOEnergyFraction", fatJetHOEnergyFraction, "fatJetHOEnergyFraction[nFatJets]/F");
	// GK  displacedJetMuonTree->Branch("fatJetHFHadronEnergyFraction", fatJetHFHadronEnergyFraction, "fatJetHFHadronEnergyFraction[nFatJets]/F");
	// GK  displacedJetMuonTree->Branch("fatJetHFEMEnergyFraction",fatJetHFEMEnergyFraction, "fatJetHFEMEnergyFraction[nFatJets]/F");
	...
	/* GK  displacedJetMuonTree->Branch("fatJetNRechits", fatJetNRechits,"fatJetNRechits[nFatJets]/I");
...
void displacedJetMuon_ntupler_small::enableMetBranches()
{
...
void displacedJetMuon_ntupler_small::enableTriggerBranches()
{
...
void displacedJetMuon_ntupler_small::enableMCBranches()
{
...
void displacedJetMuon_ntupler_small::enableGenParticleBranches()
{
...
void displacedJetMuon_ntupler_small::loadEvent(const edm::Event& iEvent)//load all miniAOD objects for the current event
{
...
void displacedJetMuon_ntupler_small::resetBranches()
{
	...
	//reset these save flags
		...
		for (uint q=0; q<hcalRecHitsHBHE->size(); q++) {
			SaveThisHCALRechit.push_back(false); // GK - set true if want to save all rechits, false if want to match to jets
		}
...
void displacedJetMuon_ntupler_small::resetEventInfoBranches()
{
	//Event
	nPV = -1;
	eventNum = 0;
...
void displacedJetMuon_ntupler_small::resetPVAllBranches()
{
	nPVAll = 0;
...
void displacedJetMuon_ntupler_small::resetPileUpBranches()
{
	nBunchXing = 0;
...
void displacedJetMuon_ntupler_small::resetMuonBranches()
{
	nMuons = 0;
...
void displacedJetMuon_ntupler_small::resetElectronBranches()
{
	nElectrons = 0;
	for(int i = 0; i < OBJECTARRAYSIZE; i++)
	{
...
void displacedJetMuon_ntupler_small::resetTauBranches()
{
	nTaus = 0;
	for(int i = 0; i < OBJECTARRAYSIZE; i++)
	{
...
void displacedJetMuon_ntupler_small::resetPhotonBranches()
{
	nPhotons = 0;
	nPhotons_overlap = 0;
	//Photon
...
void displacedJetMuon_ntupler_small::resetMuonSystemBranches()
{
	nCscSeg = 0;
	ncscRechits = 0;
	nCscSegClusters = 0;
...
void displacedJetMuon_ntupler_small::resetJetBranches()
{
	nJets = 0;
	for ( int i = 0; i < OBJECTARRAYSIZE; i++)
	{
...
void displacedJetMuon_ntupler_small::resetPFCandidateBranches()
{
	nPFCandidates = 0;
...
void displacedJetMuon_ntupler_small::resetHORechitBranches()
{
	nHORechits = 0;
...
void displacedJetMuon_ntupler_small::resetEcalRechitBranches()
{
	nRechits = 0;
...
void displacedJetMuon_ntupler_small::resetHBHERechitBranches()
{
	nHBHERechits = 0;
	for ( int i = 0; i < RECHITARRAYSIZE; i++) {
...
void displacedJetMuon_ntupler_small::resetTrackBranches()
{
	nTracks = 0;
	for ( int i = 0; i < RECHITARRAYSIZE; i++) {
		track_Pt[i] = -999.;
...
void displacedJetMuon_ntupler_small::resetSecondaryVerticesBranches()
{
...
void displacedJetMuon_ntupler_small::resetMetBranches()
{
	metPt = -999;
	metPhi = -999;
	sumMET = -99.0;
...
void displacedJetMuon_ntupler_small::resetGenParticleBranches()
{
...
void displacedJetMuon_ntupler_small::resetMCBranches()
{
	nGenJets = 0;
	for ( int i = 0; i < OBJECTARRAYSIZE; i++ )
	{
...
void displacedJetMuon_ntupler_small::resetTriggerBranches()
{
...
void displacedJetMuon_ntupler_small::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup) {
...
void displacedJetMuon_ntupler_small::beginLuminosityBlock(edm::LuminosityBlock const& iLumi, edm::EventSetup const&) {
	if (useGen_) {
...
void displacedJetMuon_ntupler_small::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup){
	using namespace edm;
...
void displacedJetMuon_ntupler_small::beginJob()
{
	setBranches();
}

//------ Method called once each job just after ending the event loop ------//
void displacedJetMuon_ntupler_small::endJob(){};



//------ Methods to fill tree variables ------//
bool displacedJetMuon_ntupler_small::fillEventInfo(const edm::Event& iEvent)
{
	isData = isData_;
...
bool displacedJetMuon_ntupler_small::fillMuonSystem(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	...
	for ( auto &tmp : ds.CscCluster ) {
		...
		for (unsigned int iHit = 0; iHit < hcalRecHitsHBHE->size(); iHit ++){
			...
			if ( deltaR(tmp.eta, tmp.phi, hiteta, hitphi)  < 0.5 ) { // in CSC Clusters section
		...
		if (isRECO_ || isBParkAOD_) {
			...
			for ( auto &tmp : ds_dtRechit.CscCluster ) {
				...
				for (unsigned int iHit = 0; iHit < hcalRecHitsHBHE->size(); iHit ++){
					...
					if ( deltaR(tmp.eta, tmp.phi, hiteta, hitphi)  < 0.5 // in the DT rechits section
							) {
						SaveThisHCALRechit[iHit] = true;
						cout << "SaveThisRechit : " << recHit->energy() << " " << hiteta << " " << hitphi << "\n";
					}
...
bool displacedJetMuon_ntupler_small::fillGenParticles(){
...
bool displacedJetMuon_ntupler_small::fillJets(const edm::EventSetup& iSetup)
{
		...
		if (j.pt() >= 20) {
	     ...
	     // //loop over hcal hits
			for (unsigned int iHit = 0; iHit < hcalRecHitsHBHE->size(); iHit ++){
			 	...
			 	if ( jetPt[nJets] > 30 && deltaR(jetEta[nJets], jetPhi[nJets], hiteta, hitphi)  < 0.5 ) { // in jet section
					SaveThisHCALRechit[iHit] = true;
					cout << "SaveThisRechit : " << recHit->energy() << " " << hiteta << " " << hitphi << "\n";
				}
			}
  ...
  //loop over hcal hits
	for (unsigned int iHit = 0; iHit < hcalRecHitsHBHE->size(); iHit ++){
		...
		if ( deltaR(fatJetEta[nFatJets], fatJetPhi[nFatJets], hiteta, hitphi)  < 1.0 ) { // fat jets section
			SaveThisHCALRechit[iHit] = true;
		}
	} 
...
bool displacedJetMuon_ntupler_small::fillMuons(const edm::Event& iEvent)
{
	for(const pat::Muon &mu : *muons) {
...
bool displacedJetMuon_ntupler_small::passJetID( const pat::Jet *jet, int cutLevel) {
	bool result = false;
...
void displacedJetMuon_ntupler_small::findTrackingVariablesWithoutPropagator(const TLorentzVector &jetVec,const edm::EventSetup& iSetup,float &alphaMax,float &medianTheta2D,float &medianIP, int &nTracksPV,float &ptAllPVTracks,float &ptAllTracks,float &minDeltaRAllTracks, float &minDeltaRPVTracks)
{
	int nTracksAll = 0;
	//Displaced jet stuff
...
void displacedJetMuon_ntupler_small::findTrackingVariables(const TLorentzVector &jetVec,const edm::EventSetup& iSetup,float &alphaMax,float &medianTheta2D,float &medianIP, int &nTracksPV,float &ptAllPVTracks,float &ptAllTracks,float &minDeltaRAllTracks, float &minDeltaRPVTracks)
{
	int nTracksAll = 0;
	//Displaced jet stuff
	double ptPVTracksMax = 0.;
...
void displacedJetMuon_ntupler_small::jet_second_moments(std::vector<double> &et,std::vector<double> &eta,std::vector<double> &phi,double &sig1,double &sig2)
{
	double mean_eta = 0.0;
	double mean_phi = 0.0;
...
const reco::Candidate* displacedJetMuon_ntupler_small::findFirstMotherWithDifferentID(const reco::Candidate *particle){
...
const reco::Candidate* displacedJetMuon_ntupler_small::findOriginalMotherWithSameID(const reco::Candidate *particle){
...
bool displacedJetMuon_ntupler_small::fillMet(const edm::Event& iEvent)
{
...
bool displacedJetMuon_ntupler_small::fillTrigger(const edm::Event& iEvent)
{
...
bool displacedJetMuon_ntupler_small::fillMC() {
...
bool displacedJetMuon_ntupler_small::fillElectrons(const edm::Event& iEvent)
{
...
bool displacedJetMuon_ntupler_small::fillPileUp()
{
...
bool displacedJetMuon_ntupler_small::fillPhotons(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
double displacedJetMuon_ntupler_small::deltaPhi(double phi1, double phi2)
{
...
double displacedJetMuon_ntupler_small::deltaR(double eta1, double phi1, double eta2, double phi2)
{
...
bool displacedJetMuon_ntupler_small::fillPVAll()
{
...
bool displacedJetMuon_ntupler_small::fillTaus(){
...
bool displacedJetMuon_ntupler_small::fillHitsTracksAndPFCands(const edm::Event& iEvent, const edm::EventSetup& iSetup) // GK 
// added "const edm::Event& iEvent," to fix error about "Called EventSetupRecord::get without using a ESGetToken." This portion not working yet!
{
	...
	// auto const& geoHandle = iSetup.getData(caloGeometryToken_); // compiles with this line, similar to how muon system is done, and recommended from twiki
	// both lines above give an error in running though, about : CastorGeometryRecord  Exception Message: No "PCastorRcd" record found in the EventSetup. Fixed by importing Run3 from Configuration.Eras.Era_Run3_cff, and using in process (in python config)
	// added includes of PCaloTowerRcd.h, ESGetToken of PCastorRcd, and ESConsumes as well

	// GK: change below from pointers (geoHandle->) to geoHandle.
	const CaloSubdetectorGeometry *barrelGeometry = geoHandle.getSubdetectorGeometry(DetId::Ecal, EcalBarrel);
	const CaloSubdetectorGeometry *endcapGeometry = geoHandle.getSubdetectorGeometry(DetId::Ecal, EcalEndcap);
	const CaloSubdetectorGeometry *hbGeometry = geoHandle.getSubdetectorGeometry(DetId::Hcal, HcalBarrel);
	const CaloSubdetectorGeometry *heGeometry = geoHandle.getSubdetectorGeometry(DetId::Hcal, HcalEndcap);
	const CaloSubdetectorGeometry *hoGeometry = geoHandle.getSubdetectorGeometry(DetId::Hcal, HcalOuter); 
	std::cout << "got geometry for HCAL rechit matching" << std::endl;
...
//*************************************************************
bool displacedJetMuon_ntupler_small::fillSecondaryVertices()
{
...
//define this as a plug-in
DEFINE_FWK_MODULE(displacedJetMuon_ntupler_small);

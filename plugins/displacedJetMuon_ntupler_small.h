...
#ifndef DISPLACEDJETMUON_NTUPLER_SMALL_H
#define DISPLACEDJETMUON_NTUPLER_SMALL_H
...
#include "Geometry/Records/interface/MuonGeometryRecord.h" // GK
...
class displacedJetMuon_ntupler_small : public edm::EDAnalyzer {
public:
  //analyzer constructor and destructor
  explicit displacedJetMuon_ntupler_small(const edm::ParameterSet&);
  ~displacedJetMuon_ntupler_small();

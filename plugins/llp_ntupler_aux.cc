...
const reco::Candidate* llp_ntupler::findFirstMotherWithDifferentID(const reco::Candidate *particle){
...
const reco::Candidate* llp_ntupler::findOriginalMotherWithSameID(const reco::Candidate *particle){
